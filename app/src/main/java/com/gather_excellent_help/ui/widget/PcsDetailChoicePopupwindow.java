...
public class PcsDetailChoicePopupwindow extends PopupWindow {
    ...
    public PcsDetailChoicePopupwindow(Context context, View vShadow){
        super(context);
        setFocusable(true);
     ...
     */
    private void init() {
        View view= inflater.inflate(R.layout.activity_detail_address_pcs_selector,null);
