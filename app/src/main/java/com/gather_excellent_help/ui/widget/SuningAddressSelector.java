...
public class SuningAddressSelector extends LinearLayout implements View.OnClickListener {
    ...
    public SuningAddressSelector(Context context) {
        super(context);
        init(context);
    }

    public SuningAddressSelector(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public SuningAddressSelector(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void onClick(View view) {
        ...
        if(onTabSelectedListener != null){
            if(tab.isSelected)
                onTabSelectedListener.onTabReselected(SuningAddressSelector.this,tab);
            else
                onTabSelectedListener.onTabSelected(SuningAddressSelector.this,tab);
        }
            ...
            holder.itemView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if(onItemClickListener != null){
                        onItemClickListener.itemClick(SuningAddressSelector.this,(Area) v.getTag(),tabIndex,position);
    ...
    public interface OnTabSelectedListener {
        void onTabSelected(SuningAddressSelector addressSelector, Tab tab);
        void onTabReselected(SuningAddressSelector addressSelector, Tab tab);
    }
    ...
    public interface OnItemClickListener {
         ...
         * */
        void itemClick(SuningAddressSelector addressSelector, Area area, int tabPosition, int position);
    }
