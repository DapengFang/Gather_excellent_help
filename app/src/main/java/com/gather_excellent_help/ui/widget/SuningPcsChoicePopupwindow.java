...
public class SuningPcsChoicePopupwindow extends PopupWindow {
    ...
    public SuningPcsChoicePopupwindow(Context context, View vShadow) {
        super(context);
        setFocusable(true);
     ...
     */
    private void init() {
        View view = inflater.inflate(R.layout.suning_address_popup, null);
        SuningAddressSelector addressSelector = (SuningAddressSelector) view.findViewById(R.id.add_test_selector);
        ...
        addressSelector.setOnItemClickListener(new SuningAddressSelector.OnItemClickListener() {
            @Override
            public void itemClick(SuningAddressSelector addressSelector, Area area, int tabPosition, int position) {
                switch (tabPosition) {
                    case 0:
                        if (province != null) {
        ...
        addressSelector.setOnTabSelectedListener(new SuningAddressSelector.OnTabSelectedListener() {
            @Override
            public void onTabSelected(SuningAddressSelector addressSelector, SuningAddressSelector.Tab tab) {
                switch (tab.getIndex()) {
                    case 0:
                        addressSelector.setCities(province, "p");
                        break;
            ...
            @Override
            public void onTabReselected(SuningAddressSelector addressSelector, SuningAddressSelector.Tab tab) {
