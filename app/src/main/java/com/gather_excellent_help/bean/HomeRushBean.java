...
public class HomeRushBean {
    ...
    public static class DataBean {
        ...
        private SiloHandlingBean silo_Handling;
        private GoodsWarmupBean goods_Warmup;
        private HotSaleBean hot_Sale;

        public TodayNewBean getToday_New() {
            return today_New;
        }

        public void setToday_New(TodayNewBean today_New) {
            this.today_New = today_New;
        }

        public SiloHandlingBean getSilo_Handling() {
            return silo_Handling;
        }

        public void setSilo_Handling(SiloHandlingBean silo_Handling) {
            this.silo_Handling = silo_Handling;
        }

        public GoodsWarmupBean getGoods_Warmup() {
            return goods_Warmup;
        }

        public void setGoods_Warmup(GoodsWarmupBean goods_Warmup) {
            this.goods_Warmup = goods_Warmup;
        }
        ...
        public void setHot_Sale(HotSaleBean hot_Sale) {
