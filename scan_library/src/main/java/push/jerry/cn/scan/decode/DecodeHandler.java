...
final class DecodeHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        switch (message.what) {
            case ConstValue.scan_decode:
                decode((byte[]) message.obj, message.arg1, message.arg2);
                break;
            case ConstValue.scan_quit:
                running = false;
        ...
        if (rawResult != null) {
            ...
            if (handler != null) {
                Message message = Message.obtain(handler,
                        ConstValue.scan_decode_succeeded, rawResult);
            ...
            if (handler != null) {
                Message message = Message.obtain(handler, ConstValue.scan_decode_failed);
                message.sendToTarget();
            }
        }
    }
